...
if __name__ == '__main__':
    ...
    ActionChains(driver).move_to_element(hover_elem).perform() #hover over the sign in nav entry to get the dropdown
    driver.find_element_by_css_selector(".nav-action-button").click() # click the link in that dropdown
    ...
    for i in range(0,numCaptchas):
        ...
        urllib.request.urlretrieve(captcha_src,"captchas/captcha%i.jpg" % (i))
